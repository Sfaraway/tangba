<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="客户账号" prop="cAccount">
        <el-input
          v-model="queryParams.cAccount"
          placeholder="请输入客户账号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="状态" prop="status">
        <el-select v-model="queryParams.status" placeholder="请选择状态(0:启用,1:停用)" clearable>
          <el-option
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['tangba:customer:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['tangba:customer:remove']"
        >删除</el-button>
      </el-col>
      <!-- <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['tangba:customer:export']"
        >导出</el-button>
      </el-col> -->
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="ID" align="center" prop="cId" />
      <el-table-column label="客户名称" align="center" prop="cname" />
      <el-table-column label="客户账号" align="center" prop="cAccount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="客户账号" prop="cAccount">
          <el-input v-model="form.cAccount" placeholder="请输入客户账号" />
        </el-form-item>
        <el-form-item label="电话" prop="phone">
...
<script>
import { listCustomer, getCustomer, delCustomer,changeCustomerStatus, addCustomer, updateCustomer } from "@/api/contractSystem/customer";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        status: [
          { required: true, message: "状态(0:启用,1:停用)不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('确认要"' + text + '""' + row.cname + '"用户吗？').then(function() {
        return changeCustomerStatus(row.cId, row.status);
      }).then(() => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('tangba/customer/export', {
        ...this.queryParams
